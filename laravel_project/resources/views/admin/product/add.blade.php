<x-adminLayout>
    ...
    <main>
        ...
        <form class="row g-3" action='{{url("admin/product/add")}}' method="post" enctype="multipart/form-data">
            @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="number" step="0.1" class="form-control" name="price" min="1" value="{{ old('price') }}">
            </div>
            <div class="col-md-6">
